...
namespace BusinessLayer.Services
{
    ...
    {
        Task<bool> CreatePortfolio(CreatePortfolioDTO createPortfolioDTO); // 포트폴리오 구매목록을 추가하고 결과를 반환하는 함수
        public Task<List<GetPortfolioDTO>> GetPortfolio(string email); // 이메일에 해당하는 포트폴리오를 가져오는 함수
        ...
        public Task<bool> DeletePortfolio(int id); // id를 기준으로 포트폴리오 구매기록을 삭제하는 함수
